...
\033[1;97m--------------------------------------------------
\033[1;91m Author      : SAJIB P
\033[1;91m GitHub      : https://github.com/SAJIB AHMED
\033[1;91m YouTube     : Termux Master
\033[1;91m Telegram    : https://t.me/SAJIB1122
\033[1;91m Blogspot    : https://SHEIKH SAJIB.blogspot.com
\033[1;97m--------------------------------------------------
"""
...
def banner():
        ...
        print (logo)
def cek_dev():
    _isi_dev_ = _s@jibvau_dapunta_('cookies.txt','r').read()
